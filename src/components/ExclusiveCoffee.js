    ...
    <section className="bg-white py-10 px-4 md:py-16 md:px-8 ">
      <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-7xl">
        ...
        <div className="space-y-6">
          <h2 className="text-green-700 font-bold text-2xl md:text-3xl lg:text-4xl">
            Arabica & Robusta
          </h2>
          ...
          <div className="flex flex-wrap gap-4">
            <button className="px-6 py-2 bg-green-600 text-white rounded-full shadow-lg hover:bg-green-700 transition duration-300">
              Read More
            </button>
        ...
        <div className="relative">
          ...
          />
          {/* Badge */}
          <div className="absolute top-10 left-0 sm:top-16 md:top-20 lg:top-24 xl:top-28 w-[10rem] sm:w-[12rem] lg:w-[15rem] h-[10rem] sm:h-[12rem] lg:h-[15rem] rounded-full border-2 border-dashed border-green-600 flex items-center justify-center">
